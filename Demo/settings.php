...
<div class="main_column column">
    ...
    <form action="settings.php" method="POST">
        Current Password: <input type="password" name="old_password" id="settings_input"><br>
        New Password: <input type="password" name="new_password_1" id="settings_input"><br>
        Repeat New Password: <input type="password" name="new_password_2" id="settings_input"><br>

        <input type="submit" name="update_password" id="update_password" value="Update Password" class="info settings_submit"><br>
