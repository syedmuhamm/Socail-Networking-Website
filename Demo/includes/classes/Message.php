...
class Message
{
    ...
    public function sendMessage($user_to, $body, $date) {
        ...
        if ($body != "") {
            $userLoggedIn = $this->user_obj->getUsername();
            $query = mysqli_query($this->con, "INSERT INTO messages (id, user_to, user_from, body, date, opened, viewed, deleted)
                                                    VALUES ('', '$user_to','$userLoggedIn','$body','$date','no','no','no' )");
        }
        //hardcoding refresh page after sending
    ...
    public function getMessages($otherUser) {
        ...
        //fetching every message and combining them into a single div
    ...
    public function getConvosDropDown($data, $limit) {
        ...
        $page = is_numeric($data['page']) ; // page is data passed from ajax, demo.js
        $userLoggedIn = $this->user_obj->getUsername();
        $return_string = "";
        $convos = array();
