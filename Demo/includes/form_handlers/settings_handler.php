...
//password configuration and update
    ...
    if (md5($old_password) == $db_password) {
        if ($new_password_1 == $new_password_2) {
            if (strlen($new_password_1) <= 4){
                $password_message = "Too few characters for new password, please try more than four characters.";
            }
            else {
            ...
            $password_message = "Your new passwords do not match, please re enter again.";
        }
    }
    else {
        $password_message = "Your old password is incorrect, please try again.";
    }
}
else {
    $password_message = "";
