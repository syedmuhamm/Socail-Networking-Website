...
<div class="main_column column">
    ...
    You can simply open your account, by simply loggin in. <br><br>

    <form action="close_account.php" method="POST">
        <input type="submit" name="close_account" id="close_account" value="Yes! Close it!" class="danger settings_submit">
        <input type="submit" name="cancel" id="update_details" value="May be, later." class="info settings_submit">
    </form>
